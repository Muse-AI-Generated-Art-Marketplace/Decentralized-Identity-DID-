...
const Credentials = () => {
  ...
  const handleScanResult = (payload) => {
    ...
    if (payload?.credentialId) {
      verifyForm.setValue("credentialId", payload.credentialId);
    }
  };
                      ...
                      render={({ field }) => (
                        <FormControl fullWidth margin="normal">
                          ...
                          <Select {...field}>
                            ...
                            <MenuItem value="age-verification">
                              Age Verification
                            </MenuItem>
                            <MenuItem value="employment-verification">
          ...
          <Grid item xs={12} md={8}>
            <Card>
              <CardContent>
                ...
                <form
                  onSubmit={verifyForm.handleSubmit(handleVerifyCredential)}
                >
                  <Controller
                    name="credentialId"
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <TextField
                          ...
                          helperText={
                            verifyForm.formState.errors.credentialId?.message
                          }
                        />
                        <Tooltip title="Scan QR Code">
                          <IconButton
                            ...
                            sx={{ mt: 2 }}
                            aria-label="Scan QR code for credential ID"
                          >
                            <QrCodeScanner />
                          </IconButton>
                        </Tooltip>
                        ...
                        <Box display="flex" alignItems="center">
                          ...
                          <Tooltip title="Copy Credential ID">
                            <IconButton
                              size="small"
                              onClick={() =>
                                copyToClipboard(result.credential.id)
                              }
                            >
                        ...
                        <Box display="flex" alignItems="center">
                          ...
                          <Tooltip title="Copy Transaction Hash">
                            <IconButton
                              size="small"
                              onClick={() =>
                                copyToClipboard(result.transaction?.hash)
                              }
                            >
                              <ContentCopy fontSize="small" />
                            </IconButton>
                ...
                <Box>
                  ...
                  >
                    <Grid container spacing={2}>
                      {Object.entries(result.credential || result).map(
                        ([key, value]) => {
                          if (
                            key === "id" ||
                            key === "valid" ||
                          ...
                          return (
                            <Grid item xs={12} key={key}>
                              <Accordion 
                                defaultExpanded={key === 'credentialSubject' || key === 'claims'}
                                sx={{ 
